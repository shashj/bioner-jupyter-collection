...
from tokenize_data_bc5cdr import HFTokenizer
...
if __name__ == "__main__":
    model_n_version = "sapbertv1"
    max_epochs = 5
    learning_rate = 2e-5
    batch_size = 16
    model_root_dir = "./.cache/sapbert/"

    hf_pretrained_model_checkpoint = "cambridgeltl/SapBERT-from-PubMedBERT-fulltext"
